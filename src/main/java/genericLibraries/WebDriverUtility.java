...
public class WebDriverUtility {
	...
	/**
	 * This method is used to wait until element/elements found  
	 * @param time
	 */
	...
	/**
	 * This method is used to drag and drop of an element to target location
	 * @param element
	 * @param target
	 */
	...
	/**
	 * This method is used select an element from drop down based on index
	 * @param element
	 * @param index
	 */
	public void selectFrmDropdown(WebElement element,int index) {
		select =new Select(element);
		select.selectByIndex(index);
	}
	/**
	 * This method is used select an element from drop down based on value
	 * @param element
	 * @param value
	 */
	...
	/**
	 * This method is used select an element from drop down based on text
	 * @param text
	 * @param element
	 */
	...
	/**
	 * This method fetches the screenshot of the web page
	 * @param driver
	 * @param jutil
	 * @param className
	 */
	...
	/**
	 * This method is used to close window or tab
	 */
